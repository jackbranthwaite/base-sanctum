...
1. Find and replace `yes` with a short ~3 character project ID to represent the application name. (e.g "My awesome app" -> "maa", "formfunfunction" -> "fff").
...
5. Generate application key
    ```bash
    docker exec yes-php php artisan key:generate
    ```
